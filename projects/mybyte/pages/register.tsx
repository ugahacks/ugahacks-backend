                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                  <div className="personal w-full pt-2">
                    ...
                    <div className="w-full md:w-full px-3 mb-6">
                      ...
                      <p>
                        NOTE: Resume will be sent to our hackathon sponsors; it
                        WILL NOT be used for hackathon acceptance decisions
                      </p>
                      <input
                        className="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                        {...register("resume", {
                    ...
                    <div className="w-full md:w-full px-3 mb-6">
                      ...
                      <div className="flex-shrink w-full inline-block relative">
                        ...
                        {errors.major && (
                          <p className="text-red-400">{errors.major.message}</p>
                        )}
                        {errors.inputMajor ? (
                          <>
                    ...
                    <div className="w-full md:w-full px-3 mb-6">
                      ...
                      />
                      {errors.school && (
                        <p className="text-red-400">{errors.school.message}</p>
                      )}
                      {otherSchool ? (
                        <input
                          className="appearance-none block w-full bg-white text-gray-700 border border-gray-400 shadow-inner rounded-md py-3 px-4 leading-tight focus:outline-none  focus:border-gray-500"
                        ...
                        render={({ field: { onChange, value } }) => (
                          <>
                            <label
                              ...
                              htmlFor="grid-text-1"
                            >
                              <em>Event Logistics Information: </em>“I authorize
                        ...
                        render={({ field: { onChange, value } }) => (
                          <>
                            <label
                              ...
                              htmlFor="grid-text-1"
                            >
                              <em>Communication from MLH: </em>“I authorize MLH
                              to send me an email where I can further opt into
                              the MLH Hacker, Events, or Organizer Newsletters
